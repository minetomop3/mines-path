...
ここでは要点だけをまとめます。HDDの選び方から順を追った詳しい手順は、初期設定に特化した記事にまとめました。これから買う方・買ったばかりの方はこちらから読んでください。

> [Synology NAS DS223j 初期設定ガイド｜開封からデータを預けられるまでの全手順](/blog/tech-ds223j-setup-guide/)
> HDDの選び方と取り付け、DSMのインストール、ストレージプールとボリューム作成、必須のセキュリティ設定、バックアップまでを順番どおりに解説します。
